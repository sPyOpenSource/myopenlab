package VectorenMatrix.Matrix_NXM.src;
...
public class MatrixNXM extends JVSMain
{
 ...
 /* private void setOutPinsDataTypeAndIO(int anzahl)
  ...
  public void propertyChanged(Object o)
  {
    ...
    private VS2DDouble copyValuesToOut()
    {
      VS2DDouble temp=new VS2DDouble(spalten.getValue(),zeilen.getValue());
      ...
      for (int i=0;i<zeilen.getValue();i++)
      {
          for (int k=0;k<spalten.getValue();k++)
          {
              ...
              temp.setValue(k,i,o.doubleValue());
