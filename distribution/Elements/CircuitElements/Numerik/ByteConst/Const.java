...
public class Const extends JVSMain
{
  ...
  private VSByte constValue=new VSByte((byte)0);
  ...
  public Const()
  {
   ...
   public void resizeWidth()
   {
     ...
     Rectangle2D   r = fm.getStringBounds(""+VSByte.toSigned(constValue.getValue()),g2);
   ...
   public void paint(java.awt.Graphics g)
   {
    if (element!=null)
    {
       ...
       g.drawString(""+VSByte.toSigned(constValue.getValue()),bounds.x+5,((bounds.height) /2)+5);
  ...
  {
    element.jAddPEItem("Wert",constValue,0,255);
    localize();
  }
