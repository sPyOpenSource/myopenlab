package MCU.StackInterpreter.FlowCharts.Decision;
...
public class Decision extends MCUMainFlow
{
  ...
  public void paint(java.awt.Graphics g)
  {
     if (element!=null)
     {
        ...
        String caption="if( "+_var.getValue().trim()+" )";

        drawCaption(g2,caption,0);
  ...
  private void generateCode()
  {
    ...
    pa=generateMCUCodeFromExpression(_var.getValue());
