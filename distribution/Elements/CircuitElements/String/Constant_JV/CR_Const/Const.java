package String.Constant_JV.CR_Const;
...
public class Const extends JVSMain
{
  ...
  private VSString constValue=new VSString("\r");
  ...
  public Const()
  {
   ...
   public void resizeWidth()
   {
       ...
       Rectangle2D   r = fm.getStringBounds("CR",g2);
   ...
   public void paint(java.awt.Graphics g)
   {
    if (element!=null)
    {
       ...
       g2.setColor(Color.black);
       g.drawString("CR",bounds.x+5,((bounds.height) /2)+5);
