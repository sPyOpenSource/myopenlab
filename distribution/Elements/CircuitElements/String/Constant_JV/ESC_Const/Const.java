package String.Constant_JV.ESC_Const;
...
public class Const extends JVSMain
{
  ...
  byte uniChar=27;
  private VSString constValue=new VSString(String.valueOf(uniChar));
  ...
  public Const()
  {
   ...
   public void resizeWidth()
   {
       ...
       Rectangle2D   r = fm.getStringBounds("ESC",g2);
   ...
   public void paint(java.awt.Graphics g)
   {
    if (element!=null)
    {
       ...
       g2.setColor(Color.black);
       g.drawString("ESC",bounds.x+5,((bounds.height) /2)+5);
  ...
  public void init()
  {
    ...
    setName("ESC_Const");
    constValue=new VSString(String.valueOf(uniChar));
  }
  ...
  public void start()
  {
      ...
      String temp = ""+ new Character((char) uniChar);
