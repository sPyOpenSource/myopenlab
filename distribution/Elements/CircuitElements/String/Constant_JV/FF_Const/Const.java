package String.Constant_JV.FF_Const;
...
public class Const extends JVSMain
{
  ...
  private VSString constValue=new VSString("\f");
  ...
  public Const()
  {
   ...
   public void resizeWidth()
   {
       ...
       Rectangle2D   r = fm.getStringBounds("FF",g2);
   ...
   public void paint(java.awt.Graphics g)
   {
    if (element!=null)
    {
       ...
       g2.setColor(Color.black);
       g.drawString("FF",bounds.x+5,((bounds.height) /2)+5);
  ...
  public void init()
  {
    ...
    setName("FormFeed_FF_Const");
    constValue=new VSString("\f");
  }
