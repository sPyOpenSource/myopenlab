...
public class RS232 extends JVSMain implements MyOpenLabDriverOwnerIF
{
  ...
  private VSBoolean RTS = new VSBoolean(false);
  private VSBoolean DTR = new VSBoolean(false);
  ...
  public void setPropertyEditor()
  {
    ...
    element.jAddPEItem("RTS",RTS, 1,2);
    element.jAddPEItem("DTR",DTR, 1,2);
  }
  ...
  public void start()
  {
    ...
    if (RTS.getValue())  driver.sendCommand(strCom+";RTSON", ""); else driver.sendCommand(strCom+";RTSOFF", "");
    if (DTR.getValue())  driver.sendCommand(strCom+";DTRON", ""); else driver.sendCommand(strCom+";DTROFF", "");
  ...
  public void loadFromStream(java.io.FileInputStream fis)
  {
      ...
      RTS.loadFromStream(fis);
      DTR.loadFromStream(fis);
  }
  ...
  public void saveToStream(java.io.FileOutputStream fos)
  {
      ...
      RTS.saveToStream(fos);
      DTR.saveToStream(fos);
