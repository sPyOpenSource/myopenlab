package Interface.SerialCOM_JV.SerialPort_Transaction_JV;
...
public class SerialPort_Transaction_JV extends JVSMain
{
  ...
  final String Element_Tag= "#Element:|SerialTransaction_JV|";
  ...
  VSInteger StartUpDelay =new VSInteger(500);
  ...
  { 
    ...
    element.jSetName("COM_Port_Transaction_JV");
    ...
    setPin(6, ExternalIF.C_INTEGER, ExternalIF.PIN_OUTPUT);
    ...
    element.jSetPinDescription(6, "Bytes_Printed_out");
    
    element.jSetPinDescription(7, "Enable_VM_in");
    element.jSetPinDescription(8, "Port_Name_in");
    element.jSetPinDescription(9, "StringOut_in");
  ...
  public void initOutputPins()
  {
    ...
    element.setPinOutputReference(6, SentBytesOut);
  }
  ...
  public void start()
  {
   ...
   element.notifyPin(6); //SentBytesOut
