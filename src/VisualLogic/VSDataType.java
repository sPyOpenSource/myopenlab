...
{    
    ...
    private static final float dash1[] = {2.0f, 1.0f};    
    private static final BasicStroke dashed1D = new BasicStroke(2.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 2.0f, dash1, 1.0f);            
    private static final float dash2[] = {2.0f, 1.0f};
    private static final BasicStroke dashed2D = new BasicStroke(3.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 1.0f, dash2, 1.0f);        
    private static final BasicStroke dashedGrp = new BasicStroke(2.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 2.0f, dash2, 1.0f);        
    private static final Stroke standard = new BasicStroke( 2 );        
